...
export default function Login() {
  ...
  <div className="bg-black px-8 py-4 rounded-lg flex justify-center items-center">
    <img
      src="/assets/sou1.png"   // <-- replace with your logo path
      alt="Souqnests Logo"
    ...
    />
        ...
        <h1 className="mb-6 mt-1 text-2xl font-bold text-slate-900">Sign In to Souqnests</h1>

        {/* Alerts */}
        {msg && (
          <div
            className={`mb-4 rounded-lg border px-3 py-2 text-sm ${msg.type === "ok"
